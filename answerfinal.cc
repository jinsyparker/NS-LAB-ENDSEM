...
// graph command = awk -f pdf-graph mixed-global-routing.tr > 123.txt   (123.txt is any name you would want to give)
//go in pdf-graphcode and change the text file name to 123.txt, then run the following command
// gnuplot pdf-graphcode


//for delay, command= awk -f delay-graph mixed-global-routing.tr > 123.txt
//go in delay-graphcode and keep field ass the plot"123.txt", then run next command
// gnuplot delay-graphcode



//for throughput , command =awk -f throughput mixed-global-routing.tr > 123.txt
//go in throughput-graphcode and keep field as 123.txt
//gnuplot throughput-graphcode


//to see throughput on terminal, command= awk -f throughput.awk mixed-global-routing.tr
